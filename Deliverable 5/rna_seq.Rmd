...
meta_data <- read.csv("full_metadata.csv", row.names = 1)
...
blood.counts.df <- read.csv("bloodcounts.csv", row.names = 1)
nasal.counts.df <- read.csv("nasalcounts.csv", row.names = 1)

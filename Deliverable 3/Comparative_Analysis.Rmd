...
# setwd("~/Documents/.../Meta-omic-Analysis-Capstone/Deliverable 3/data")

results_1_df <- read_csv("NasalCVID_results_top250.csv")
nasal_deseq <- results_1_df$deseq250
nasal_limma <- results_1_df$limma250

results_2_df <- read_csv("PBMC_results_top250.csv")
ctrl_deseq <- results_df$ctrl_deseq
ctrl_limma <- results_df$ctrl_limma
LPS_deseq <- results_df$LPS_deseq
LPS_limma <- results_df$LPS_limma

```

## Comparison {.tabset}

### Common Significant genes: LPS v. Healthy Control
...
### Nasal and Control PBMC - DESeq

### Nasal and Control PBMC - Limma

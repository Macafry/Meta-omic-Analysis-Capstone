...
### Load top 1000 DEGs per sample/group

```{r}
# WD set to /Deliverable 4/data directory
# setwd("~/Documents/.../Meta-omic-Analysis-Capstone/Deliverable 4")

results_1_df <- read_csv("data/NasalCVID_results_top1000.csv")
nasal_deseq <- results_1_df$deseq1000
nasal_limma <- results_1_df$limma1000

results_2_df <- read_csv("data/PBMC_results_top1000.csv")
